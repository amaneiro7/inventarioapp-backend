...
const sites = [
	{
		...
		address:
			'Av. Vollmer, Centro Empresarial Caracas, Torre Sur, P.B, Urb. San Bernardino, Municipio Libertador, Caracas, Distrito Capital.',
	...
	},
	{
		...
		address:
			'Av. Principal de San Martín, calle B de la Zona Industrial San Martín, P.B, Parroquia San Juan, Municipio Libertador, Caracas, Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'Av. Urdaneta, Esquina Urapal, Conjunto Residencial Comercial Casabera, Locales PB01-PB02, PB., Urb. La Candelaria. Caracas, Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'Av. Andrés Bello, Sector Guaicaipuro, Fundación Hospital Ortopédico Infantil, Parroquia El Recreo, Municipio Libertador, Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Av. España, Boulevard El Atlántico, Edificio Ema, P.B., Urb. Nueva Caracas, Municipio Libertador. Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Entre Av. Casanova Godoy y Universidad, Calle Los Caobos con Av. 108, C.C. Platinum. Maracay, Estado Aragua.',
	...
	},
	{
		...
		address:
			'Av. Bogotá con Calle La Pica, C.C. Mercado San Jorge, Local J189, PB., El Cementerio. Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		name: '(45) unare',
		address:
			'Av. Paseo Caroní Con Calle Cupire, Centro Comercial Unare II, Municipio Caroní, Puerto Ordaz, Estado Bolívar.',
	...
	},
	{
		...
		address:
			'Avenida Francisco de Miranda, Entre 3ra. Y 4ta. Avenida de Los Palos Grandes, Edif. Parque Cristal, Nivel Comercial 1, Locales Lcc1-25, Lcc1-26, Lcc1-27, Municipio Chacao, Estado\n                  Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'Instalación del Club Hebraica, Avenida Principal de Los Chorros, Centro Social Hebraica, Urbanización Los Chorros, Caracas, Estado miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'Hotel Radisson Plaza Eurobuilding, Nivel Lobby, Ala Este, Local N° 3 y 4, Urbanización Chuao, Municipio Baruta, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		name: '(52) Altamira',
		address:
			'Av. San Juan Bosco y Av. San Felipe, Edf. Centro Altamira, Locales 3-5, PB., Urbanización Altamira. Municipio Chacao, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		name: '(53) San Román',
		address:
			'Av. Panorama, C.C. El Mirador, Local 01, Sótano, Lomas del Mirador, Urbanización San Román, Municipio Baruta, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'Av. Principal de Alto Prado, C.C. Alto Prado, Locales 11 y 30, PB. y Mezzanina, Urb. Alto Prado, Municipio Baruta, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'Av. La Estancia, C.C.C.T., Nivel C-2, Local 53-M-02, Urb. Chuao, Municipio Chacao, Caracas, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'C.C. Plaza Las Américas, Segunda Etapa, Nivel Comercio 2, Locales COM2-6, Urbanizacion El Cafetal, Municipio Baruta, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		name: '(59) Av. Victoria',
		address:
			'Av. Presidente Medina con Av. Nueva Granada, C.C. Multiplaza Victoria, Local V-4, PB., Sector El Peaje, Urb. Las Acacias. Caracas, Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Calle 1 entre Av. Bolívar y Miranda, Torre Sindoni, Local 19, PB. Municipio Girardot, Maracay, Estado Aragua.',
		cityId: cities.filter(city => city.name === cityOnlyNames.MARACAY)[0].id
	},
	{
		...
		address:
			'Carretera Nacional Cagua - La Villa, Parcela 4, Supermercado Super Líder, Sector La Becerrita. Municipio Sucre, Cagua, Estado Aragua.',
	...
	},
	{
		...
		address:
			'Av. Caracas con cruce Francisco Yépez Fernández, Supermercado Super Líder, Sector Niño Jesús, Lote N°2. Municipio Mario Briceño Iragorry, Maracay, Estado Aragua.',
		cityId: cities.filter(city => city.name === cityOnlyNames.MARACAY)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Avenida Las Delicias Urbanización el Bosque, Parcela N°32, Parroquia María Madre de San José, Municipio Girardot, Maracay, Estado Aragua.',
		cityId: cities.filter(city => city.name === cityOnlyNames.MARACAY)[0].id
	},
	{
		...
		address:
			'Avenida La Estación, Entre Calles Páez, Mariño y Soublette, Centro Comercial Paseo Estación Central, Sector Centro De Maracay, Parroquia Madre María De San José, Municipio Girardot,\n                  Estado Aragua.',
		cityId: cities.filter(city => city.name === cityOnlyNames.MARACAY)[0].id
	},
	{
	...
	},
	{
		...
		name: '(88) Cagua',
		address:
			'Calle Sucre con Calle Cajigal, C.C. La Pirámide, Locales A-17/A-20, PB. Cagua, Municipio Sucre, Estado Aragua.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CAGUA)[0].id
	},
	{
	...
	},
	{
		...
		name: '(98) El Rosal',
		address:
			'Avenida Francisco De Miranda, Con Avenida Los Cortijos, Urb. Campo Alegre, Parroquia Chacao, Municipio Chacao, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Avenida Vargas, cruce con calle Paez, Edificio Halbi PB, Maracay, Parroquia Pedro José Ovalles, Municipio Girardot, Estado Aragua',
		cityId: cities.filter(city => city.name === cityOnlyNames.MARACAY)[0].id
	},
	{
	...
	},
	{
		...
		name: '(112) El Vigía',
		address:
			'Av. Bolívar, Edf. Los Alpes N° 2-28, frente al Centro Cultural Mariano Picon Salas. El Vigia, Municipio Alberto Adriani, Estado Mérida.',
	...
	},
	{
		...
		address:
			'Sede de la Alcaldía de Casanay, entre Calle Caracas y final de Calle Venezuela, Municipio Andrés Eloy Blanco, Casanay, Estado Sucre.',
	...
	},
	{
		...
		address:
			'Av. Rómulo Gallegos, Edif. Omar, al lado del C.C. Fady, Parroquia San Antonio, Municipio Miranda, Estado falcon.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CORO)[0].id
	},
	{
	...
	},
	{
		...
		name: '(133) Choroní',
		address:
			'Carretera Choroní, Vía Puerto Colombia. Entre El Pueblo de Camping y Puerto Colombia. Municipio Girardot, Choroní, Estado Aragua.',
	...
	},
	{
		...
		address:
			'Av. Las Delicias, Urb. El Bosque, Edif. Centro Médico Maracay, Parroquia Choroní, Municipio Girardot, Estado Aragua.',
		cityId: cities.filter(city => city.name === cityOnlyNames.MARACAY)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Av. Francisco de Miranda cruce con calle Guanchez Edificio Valencia II PB, Municipio Sucre, Parroquia Leoncio Martínez, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		name: '(151) Maturin II',
		address:
			'Av. Luis del Valle Garcia con calle 3, Barrio Carnevali de Maturin, Parroquia San Simón, Estado Monagas.',
	...
	},
	{
		...
		address:
			'Av. Gonzalez Rincones, Edf. Centro-Ven, Locales 8 Y 9, P.B, Zona Industrial La Trinidad, Caracas, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'Avenida Rio Paragua, Autopista Prados Del Este, Barrio Santa Cruz Del Este, Centro Italiano Venezolano, Parroquia Baruta, Municipio Baruta, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Av. Suiza Con Calle Pie de Monte, Urbanización Alto Barinas, Hotel Eurobuilding Express Barinas, Municipio Barinas, Estado Barinas.',
	...
	},
	{
		...
		address:
			'Avenida Arturo Michelena, Cruce con Calle Codazzi, Urbanización Santa Mónica, Parroquia San Pedro, Municipio Libertador, Caracas, Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Local LF-1 Piso 1, Av. Intercomunal, Sector la INOS al lado de Makro, Parroquia Jorge Hernández, Municipio Cabimas, Estado Zulia',
	...
	},
	{
		...
		address:
			'Avenida Intercomunal Guarenas-Guatire, Con Calle Los Bucares, Hipermercado Central Madeirense, Local Nº 10, Guatire, Municipio Zamora, Estado Miranda.',
	...
	},
	{
		...
		name: '(175) La Morita',
		address:
			'Centro Comercial Híper Líder La Morita, En La Prolongación De La Avenida Aragua, Sector La Morita, Ciudad de Maracay, Municipio Santiago Mariño, Estado Aragua.',
		cityId: cities.filter(city => city.name === cityOnlyNames.MARACAY)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Av. Humboldt con Av. Las Palomas, Centro Comercial Híper Galerías Cumaná, Planta Nivel Ayacucho, Local L-81, Parroquia Santa Inés de Cumaná, Municipio Sucre, Estado Sucre.',
	...
	},
	{
		...
		address:
			'Av. Blandín con Calle Teresa de Jesús, Centro San Ignacio, Nivel Chaguaramos. Urbanizacion La Castellana, Municipio Chacao, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'(*)Agencia Cerrada Temporalmente, sus Clientes serán Atendidos en la Agencia La Candelaria Casabera Av. Urdaneta, Esquina Urapal, Conjunto Resid. Comercial Casabera, P.B., Locales Nº\n                  Pb1 Y Pb2, Municipio Libertador, Caracas, Distrito Capital',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		name: '(196) Barinas',
		address:
			'Centro Comercial Los Mangos, Avenida Cruz Paredes de la Ciudad de Barinas, Municipio Barina, Estado Barinas.',
		cityId: cities.filter(city => city.name === cityOnlyNames.BARINAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Centro Comercial Mariño Plaza, Calle Mariño con Calle Peñalver, Parroquia Turmero, Municipio Santiago Mariño, Estado Aragua.',
	...
	},
	{
		...
		address:
			'Av. Francisco Solano López y Calle Negrín, Centro Residencial Solano, Primera Etapa, Urbanización Sabana Grande, Parroquia El Recreo, Municipio Libertador, Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Av. Jose Maria Vargas Urbanización Santa Fe Norte Centro Comercial Santa Fe Sotano 2, Municipio Baruta, Caracas, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'Supermercado Excelsior Gama Plus, Av Romulo Gallegos Entre 1era y 2da Avenida, Urbanizacion Sta Eduvigis, Municipio Sucre, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		name: '(220) Boleita',
		address:
			'4ta. Transversal De Monte Cristo, Los Dos Caminos Centro Empresarial Boleita, Municipio Sucre, Caracas, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'Av. Casanova Godoy C.C. Unicentro, Local Pb. Local 7,Parroquia Madre Maria de José Maracay Estado Aragua',
		cityId: cities.filter(city => city.name === cityOnlyNames.MARACAY)[0].id
	},
	{
		...
		address:
			'Av. Zulia C/C Av. Mérida, Edf. Banco Del Orinoco, P.B. (Frente A La Alcaldía). Municipio Anaco, Anaco, Estado. Anzoátegui.',
	...
	},
	{
		...
		name: '(234) El Tigre',
		address:
			'Av. Francisco De Miranda Sur E/C 11 Y 12, Edificio B.O.D. Municipio Simón Rodriguez, El Tigre - Estado. Anzoátegui',
	...
	},
	{
		...
		address:
			'(*)Agencia Cerrada Temporalmente, sus Clientes serán Atendidos en la Agencia San Fernando De Apure Avenida Caracas Con Avenida Girardot, Centro Comercial Villacenter, San Fernando De\n                  Apure, Municipio San Fernando, Parroquia San Fernando, Estado Apure.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'(*)Agencia Cerrada Temporalmente, sus Clientes serán Atendidos en la Agencia Maracay Los Samanes: Final Av. Bermúdez, Hipermercado Súper líder los Samanes, galpón nº 1, zona\n                  industrial los samanes, Municipio Girardot, Maracay, Estado Aragua.',
		cityId: cities.filter(city => city.name === cityOnlyNames.MARACAY)[0].id
	},
	{
		...
		address:
			'(*)Agencia Cerrada Temporalmente, sus Clientes serán Atendidos en la Agencia Palo Negro Súper Líder Carretera Nacional Palo Negro, Sector Palo Negro, Vía Magdaleno, C.C. Súper Líder,\n                  Local Nº 4, Palo Negro, Mun. Libertador, Edo Aragua.',
		cityId: cities.filter(city => city.name === cityOnlyNames.MARACAY)[0].id
	},
	{
	...
	},
	{
		...
		name: '(243) Guacara',
		address:
			'(*)Agencia Cerrada Temporalmente, sus Clientes serán Atendidos en la Agencia Las Garcitas Valencia: Parque Industrial Las Garcitas, Local Nº2, Carretera Nacional\n                  Valencia-Caracas,Estado Carabobo.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Av. San Martín, Centro Comercial Los Molinos, Locales 25 Al 28 Nivel Mezzanina, Caracas, Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Av. Ppal De La Yaguara Con Calle Seis. Centro Empresarial Melo, P.B.Frente Al Vivex. La Yaguara, Caracas, Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Av. Abraham Lincoln, Calle unión y Calle Villa flor C.C. City Market, Nivel Feria Locales 303 al 308. Boulevard De Sabana Grande, Caracas, Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'Av. Teherán Sede UCAB Planta Baja Montalbán, Municipio Libertador, Parroquia La Vega, Caracas, Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
		...
		address:
			'Av. Baralt, Frente Al Mercado De Quinta Crespo,Torre Gavi, Local 2 Planta Baja y Mezzanina, Caracas, Distrito Capital.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Av. Cardenal Quintero Entre Principal Viaducto Campo Elias Y Av. Los Próceres. C.C. Viaducto. Mérida, Estado Mérida',
		cityId: cities.filter(city => city.name === cityOnlyNames.MERIDA)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'(*)Agencia Cerrada Temporalmente, sus Clientes serán Atendidos en la Agencia Los Dos Camino Av. Francisco De Miranda Cruce Con Calle Guánchez Edificio Valencia II PB, Municipio\n                  Sucre, Parroquia Leoncio Martínez, Edo Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		name: '(276) El Marques',
		address:
			'Av. Francisco De Miranda, Unicentro El Marques Nivel 1, P.B. Local 104 Y 107 El Marques, Caracas, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'Av. Intercomunal Guarenas - Guatire, Centro Comercial Buenaventura, Local C-35, Guatire, Estado Miranda.',
		cityId: cities.filter(city => city.name === cityOnlyNames.GUATIRE)[0].id
	},
	{
	...
	},
	{
		...
		address:
			'(*)Agencia Cerrada Temporalmente, sus Clientes serán Atendidos en la Agencia Av Blandin ubicada en la Torre La Castellana Edf. Anexo Entre Calle Mohedano Y Blandin Planta Baja La\n                  Castellana., Caracas.',
		cityId: cities.filter(city => city.name === cityOnlyNames.CARACAS)[0].id
	},
	{
