...
const siteName = {
	...
	TORREBNC5DEJULIOSALASDECONFERENCIA:
		'Torre BNC 5 de Julio Salas de Conferencia'
}

const siteMCBOlocation = [
	{
		id: 'b72b6168-440f-42c0-8d53-3f0c6ca850d5',
		typeOfSiteId: typeOfSite.filter(
			type => type.name === typeOfSiteOnlyName.SEDE
		)[0].id,
		siteId: parsedSite.filter(
			site => site.name === siteOnlyNames.MARACAIBO5DEJULIO
		)[0].id,
...
const almacenes = [
	{
		...
		typeOfSiteId: typeOfSite.filter(
			type => type.name === typeOfSiteOnlyName.ALMACEN
		)[0].id,
		siteId: parsedSite.filter(
			site => site.name === siteOnlyNames.MARACAIBO5DEJULIO
		)[0].id,
...
const agenciasSite = [
	{
		...
		typeOfSiteId: typeOfSite.filter(
			type => type.name === typeOfSiteOnlyName.AGENCIA
		)[0].id,
