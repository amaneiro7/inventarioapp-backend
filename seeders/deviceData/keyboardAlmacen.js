...
const keyboadAlmacen = [
	{
		...
		activo: '274',
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'RT7D20'
		)[0].categoryId,
		modelId: keyboardModel.filter(keyboard => keyboard.name === 'RT7D20')[0]
			.id,
		brandId: keyboardModel.filter(keyboard => keyboard.name === 'RT7D20')[0]
			.brandId,
		employeeId: null,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'GK-070006/U'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'GK-070006/U'
		)[0].id,
		brandId: keyboardModel.filter(
			keyboard => keyboard.name === 'GK-070006/U'
		)[0].brandId,
		employeeId: null,
		locationId: locations.filter(
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'GK-100016'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'GK-100016'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'K639'
		)[0].categoryId,
		modelId: keyboardModel.filter(keyboard => keyboard.name === 'K639')[0]
			.id,
		brandId: keyboardModel.filter(keyboard => keyboard.name === 'K639')[0]
			.brandId,
		employeeId: null,
		locationId: locations.filter(
			location =>
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'KB-100011'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'KB-100011'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'KU-0138'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'KU-0138'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'KB-0316'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'KB-0316'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'KU-0133'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'KU-0133'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'KU-0316'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'KU-0316'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'PR1101U'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'PR1101U'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'SK-2085'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'SK-2085'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'SK-2880'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'SK-2880'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'SK-2885'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'SK-2885'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'KB-0225'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'KB-0225'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'KU-0225'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'KU-0225'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'KUF0452'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'KUF0452'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'LXH-EKB-10YA'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'LXH-EKB-10YA'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'SK-8825'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'SK-8825'
		)[0].id,
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === '1366'
		)[0].categoryId,
		modelId: keyboardModel.filter(keyboard => keyboard.name === '1366')[0]
			.id,
		brandId: keyboardModel.filter(keyboard => keyboard.name === '1366')[0]
			.brandId,
		employeeId: null,
		locationId: locations.filter(
			location =>
	...
	},
	{
		...
		statusId: 2,
		categoryId: keyboardModel.filter(
			keyboard => keyboard.name === 'KU-1079'
		)[0].categoryId,
		modelId: keyboardModel.filter(
			keyboard => keyboard.name === 'KU-1079'
		)[0].id,
