...
const impresorasFinancieraAlmacen = [
	{
		...
		activo: null,
		statusId: 2,
		categoryId: modelPrinter.filter(
			printer => printer.name === 'HighPrint 4915xe'
		)[0].categoryId,
		modelId: modelPrinter.filter(
			printer => printer.name === 'HighPrint 4915xe'
		)[0].id,
		brandId: modelPrinter.filter(
			printer => printer.name === 'HighPrint 4915xe'
		)[0].brandId,
		employeeId: null,
	...
	},
	{
		...
		statusId: 2,
		categoryId: modelPrinter.filter(
			printer => printer.name === 'HighPrint 4915+'
		)[0].categoryId,
		modelId: modelPrinter.filter(
			printer => printer.name === 'HighPrint 4915+'
		)[0].id,
