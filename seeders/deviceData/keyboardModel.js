...
const keyboardModel = [
	{
		...
		inputType: inputTypes.filter(inputType => inputType.name === 'PS/2')[0]
			.id
	},
	{
		...
		inputType: inputTypes.filter(inputType => inputType.name === 'USB')[0]
			.id
	},
	{
	...
	},
	{
		...
		name: 'KB-0316',
		categoryId: 10,
		brandId: brandsData.filter(brand => brand.name === 'Hewlett-Packard')[0]
			.id,
		inputType: inputTypes.filter(inputType => inputType.name === 'PS/2')[0]
			.id
	},
