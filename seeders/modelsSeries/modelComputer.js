...
const {
	memoryRamType,
	memoryRamTypeName
} = require('../memoryRam/memoryRamType')
...
const modelComputer = [
	{
		...
		memoryRamTypeId: memoryRamType.filter(
			memory => memory.name === memoryRamTypeName.DDR3
		)[0].id,
	...
	},
	{
		...
		memoryRamTypeId: memoryRamType.filter(
			memory => memory.name === memoryRamTypeName.DDR3L
		)[0].id,
		memoryRamSlotQuantity: 2,
		hasBluetooth: true,
		hasWifiAdapter: true,
	...
	},
	{
		...
		memoryRamTypeId: memoryRamType.filter(
			memory => memory.name === memoryRamTypeName.DDR4
		)[0].id,
		memoryRamSlotQuantity: 2,
		hasBluetooth: false,
		hasWifiAdapter: false,
	...
	},
	{
		...
		memoryRamTypeId: memoryRamType.filter(
			memory => memory.name === memoryRamTypeName.DDR2
		)[0].id,
		memoryRamSlotQuantity: 2,
		hasBluetooth: false,
		hasWifiAdapter: false,
	...
	},
	{
		...
		brandId: brandsData.filter(brand => brand.name === brandOnlyName.HP)[0]
			.id,
		memoryRamTypeId: memoryRamType.filter(
			memory => memory.name === memoryRamTypeName.DDR4L
		)[0].id,
		memoryRamSlotQuantity: 2,
		hasBluetooth: true,
		hasWifiAdapter: true,
	...
	},
	{
		...
		memoryRamTypeId: memoryRamType.filter(
			memory => memory.name === memoryRamTypeName.DDR2L
		)[0].id,
		memoryRamSlotQuantity: 2,
		hasBluetooth: true,
		hasWifiAdapter: true,
...

	{
		...
		brandId: brandsData.filter(
			brand => brand.name === brandOnlyName.AZULLE
		)[0].id,
		memoryRamTypeId: memoryRamType.filter(
			memory => memory.name === memoryRamTypeName.DDR4L
		)[0].id,
	...
	},
	{
		...
		brandId: brandsData.filter(brand => brand.name === brandOnlyName.HP)[0]
			.id,
		memoryRamTypeId: memoryRamType.filter(
			memory => memory.name === memoryRamTypeName.DDR1
		)[0].id,
		memoryRamSlotQuantity: 2,
		hasBluetooth: false,
		hasWifiAdapter: false,
	...
	},
	{
		...
		brandId: brandsData.filter(brand => brand.name === brandOnlyName.OEM)[0]
			.id,
		memoryRamTypeId: memoryRamType.filter(
			memory => memory.name === memoryRamTypeName.DDR2
		)[0].id,
