...
const {
	categoryBAMData,
	categoryBamOnlyNames
} = require('../categoryData/newCategories')
...
const modelBAM = [
	{
		...
		name: 'USB TL-WN821N',
		categoryId: categoryBAMData.filter(
			category => category.name === categoryBamOnlyNames.ANTENAS
		)[0].id,
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.TPLINK
		)[0].id
	},
	{
		...
		categoryId: categoryData.filter(
			category => category.name === categoryOnlyNames.BAM
		)[0].id,
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.ALCATEL
		)[0].id
	},
	{
		...
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.HAIER
		)[0].id
	},
	{
		...
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.JIO
		)[0].id
	},
	{
		...
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.TOTOLINK
		)[0].id
	},
	{
	...
	},
	{
		...
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.ZTE
		)[0].id
	},
	{
	...
	},
	{
		...
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.GELSI
		)[0].id
	},
	{
	...
	},
	{
		...
		name: 'Cable USB',
		categoryId: categoryBAMData.filter(
			category => category.name === categoryBamOnlyNames.CABLEUSB
		)[0].id,
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.HP
		)[0].id
	},
	{
		...
		name: 'FaceCam 321',
		categoryId: categoryBAMData.filter(
			category => category.name === categoryBamOnlyNames.WEBCAM
		)[0].id,
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.GENIUS
		)[0].id
	},
	{
	...
	},
	{
		...
		name: 'DMC-LS70',
		categoryId: categoryBAMData.filter(
			category => category.name === categoryBamOnlyNames.CAMARAS
		)[0].id,
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.PANASONIC
		)[0].id
	},
	{
		...
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.SAMSUNG
		)[0].id
	},
	{
		...
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.SONY
		)[0].id
	},
	{
		...
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.CISCO
		)[0].id
	},
	{
		...
		name: 'Air A1475',
		categoryId: categoryBAMData.filter(
			category => category.name === categoryBamOnlyNames.IPAD
		)[0].id,
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.APPLE
		)[0].id
	},
	{
		...
		categoryId: categoryData.filter(
			category => category.name === categoryOnlyNames.PHONE
		)[0].id,
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.MICROSOFT
		)[0].id
	},
	{
		...
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.TARGUS
		)[0].id
	},
	{
		...
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.XIAMI
		)[0].id
	},
	{
		...
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.NOKIA
		)[0].id
	},
	{
	...
	},
	{
		...
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.MOTOROLA
		)[0].id
	},
	{
	...
	},
	{
		...
		brandId: brandsBamData.filter(
			category => category.name === brandBAMOnlyName.HUAWEI
		)[0].id
	},
	{
	...
	},
	{
		...
		categoryId: categoryBAMData.filter(
			category =>
				category.name === categoryBamOnlyNames.CONVERTIDORVGAHDMI
		)[0].id,
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.LENOVO
		)[0].id
	},
	{
		...
		name: 'SP-i170',
		categoryId: categoryBAMData.filter(
			category => category.name === categoryBamOnlyNames.CORNETAS
		)[0].id,
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.GENIUS
		)[0].id
	},
	{
		...
		name: 'HSA-Q001PR',
		categoryId: categoryBAMData.filter(
			category => category.name === categoryBamOnlyNames.DOCKING
		)[0].id,
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.HP
		)[0].id
	...
	},
	{
		...
		name: 'Active Pen G2',
		categoryId: categoryBAMData.filter(
			category => category.name === categoryBamOnlyNames.LAPIZOPTICO
		)[0].id,
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.HP
		)[0].id
	},
	{
		...
		name: 'Y1215P',
		categoryId: categoryBAMData.filter(
			category => category.name === categoryBamOnlyNames.MIC
		)[0].id,
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.GENIUS
		)[0].id
	},
	{
		...
		name: 'Elite',
		categoryId: categoryData.filter(
			category => category.name === categoryOnlyNames.MOUSE
		)[0].id,
		brandId: brandsData.filter(
			category => category.name === brandOnlyName.HP
		)[0].id,
		inputTypesId: inputTypes.filter(
			inputType => inputType.name === inputTypesOnlyName.Wireless
		)[0].id
	},
	{
