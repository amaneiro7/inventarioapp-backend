...
const modelMonitor = [
	{
		...
		categoryId: categoryData.filter(
			cat => cat.name === categoryOnlyNames.MONITORES
		)[0].id,
		brandId: brandsData.filter(brand => brand.name === brandOnlyName.AOC)[0]
			.id,
		screenSize: 18.5,
		hasDVI: false,
		hasHDMI: false,
	...
	},
	{
		...
		brandId: brandsData.filter(
			brand => brand.name === brandOnlyName.COMPAQ
		)[0].id,
		screenSize: 20,
		hasDVI: false,
		hasHDMI: false,
	...
	},
	{
		...
		brandId: brandsData.filter(brand => brand.name === brandOnlyName.IBM)[0]
			.id,
		screenSize: 17,
		hasDVI: false,
		hasHDMI: false,
	...
	},
	{
		...
		brandId: brandsData.filter(brand => brand.name === brandOnlyName.LG)[0]
			.id,
		screenSize: 17,
		hasDVI: false,
		hasHDMI: false,
	...
	},
	{
		...
		brandId: brandsData.filter(
			brand => brand.name === brandOnlyName.SAMSUNG
		)[0].id,
		screenSize: 18.5,
		hasDVI: false,
		hasHDMI: false,
...

	{
		...
		brandId: brandsData.filter(
			brand => brand.name === brandOnlyName.ACER
		)[0].id,
		screenSize: 21.5,
		hasDVI: false,
		hasHDMI: false,
	...
	},
	{
		...
		brandId: brandsData.filter(
			brand => brand.name === brandOnlyName.BENQ
		)[0].id,
		screenSize: 27,
		hasDVI: false,
		hasHDMI: false,
	...
	},
	{
		...
		brandId: brandsData.filter(
			brand => brand.name === brandOnlyName.SEIKI
		)[0].id,
		screenSize: 32,
		hasDVI: false,
		hasHDMI: false,
	...
	},
	{
		...
		brandId: brandsData.filter(
			brand => brand.name === brandOnlyName.VIEWSONIC
		)[0].id,
		screenSize: 17,
		hasDVI: false,
		hasHDMI: false,
