...
const agenciaInsular = [
    ...
    },
    {
        ...
        memoryRamCapacity: 4,
        memoriaRamModules: transformarStringToArray('1_1_1_1', modelComputer.find(model => model.name === "HP Compaq dc5800 Small Form Factor").slots),
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i3-2100 CPU @ 3.10GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 6,
        memoriaRamModules: transformarStringToArray('2_4', modelComputer.find(model => model.name === "HP Compaq 6200 Pro SFF PC").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['80']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 7 Professional ']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['32 bits']).id,
