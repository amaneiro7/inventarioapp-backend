...
const torreBoleita = [
    {
        ...
        memoriaRamModules: transformarStringToArray('8_8', modelComputer.find(model => model.name === "HP ProDesk 600 G1 SFF").slots),
    ...
    },
    {
        ...
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('4_4', modelComputer.find(model => model.name === "ThinkCentre M73z").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
    ...
    },
    {
        ...
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('8_8', modelComputer.find(model => model.name === "HP EliteDesk 800 G4 DM 35W (TAA)").slots),
    ...
    },
    {
        ...
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('16', modelComputer.find(model => model.name === "HP EliteDesk 800 G4 DM 65W (TAA)").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i7-8700 CPU @ 3.20GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('8_8', modelComputer.find(model => model.name === "HP EliteDesk 800 G4 DM 65W (TAA)").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        memoryRamCapacity: 6,
        memoriaRamModules: transformarStringToArray('2_2_2', modelComputer.find(model => model.name === "HP Compaq Elite 8300 SFF").slots),
    ...
    },
    {
        ...
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('8_8', modelComputer.find(model => model.name === "HP ProDesk 400 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro N']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5 CPU         650  @ 3.20GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('8_8', modelComputer.find(model => model.name === "HP Compaq 8100 Elite CMT PC").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
    ...
    },
    {
        ...
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('8_8', modelComputer.find(model => model.name === "ThinkCentre M700").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 7 Professional']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['32 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i3-3120M CPU @ 2.50GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 6,
        memoriaRamModules: transformarStringToArray('2_4', modelComputer.find(model => model.name === "Lenovo G480").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro N']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i7-8700 CPU @ 3.20GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('16', modelComputer.find(model => model.name === "HP EliteDesk 800 G4 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('16', modelComputer.find(model => model.name === "HP EliteBook x360 830 G6").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Pentium(R) CPU G640 @ 2.80GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('8', modelComputer.find(model => model.name === "HP Compaq Pro 4300 SFF PC").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-4590 CPU @ 3.30GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('8', modelComputer.find(model => model.name === "HP ProDesk 400 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['SDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['32 bits']).id,
    ...
    },
    {
        ...
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('8', modelComputer.find(model => model.name === "Lenovo C260").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['SDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('8', modelComputer.find(model => model.name === "HP Compaq Pro 6300 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['SDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-8500T CPU @ 2.10GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('16', modelComputer.find(model => model.name === "HP EliteDesk 800 G4 DM 35W (TAA)").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('8', modelComputer.find(model => model.name === "ThinkCentre M72e").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i3-3220 CPU @ 3.30GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('4_4', modelComputer.find(model => model.name === "HP Compaq Pro 6300 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro for Workstations']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
        macAddress: null,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i7-7700 CPU @ 3.60GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('8', modelComputer.find(model => model.name === "ThinkCentre M710s").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i7-7700 CPU @ 3.60GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('8_8', modelComputer.find(model => model.name === "ThinkCentre M710s").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-6400 CPU @ 2.70GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('4_4', modelComputer.find(model => model.name === "ThinkCentre M700").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 7 Professional']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['32 bits']).id,
    ...
    },
    {
        ...
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('8_8', modelComputer.find(model => model.name === "HP EliteBook x360 1030 G3").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['SDDM2']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i3-2130 CPU @ 3.40GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('4_4', modelComputer.find(model => model.name === "ThinkCentre M72e").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-4570 CPU @ 3.20GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('8_4_4', modelComputer.find(model => model.name === "HP ProDesk 600 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 7 Professional']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        memoriaRamModules: transformarStringToArray('8_4_4_4', modelComputer.find(model => model.name === "HP ProDesk 600 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 7 Professional']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i3-2120 CPU @ 3.30GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('4_4', modelComputer.find(model => model.name === "ThinkCentre M71e").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i7-4770 CPU @ 3.40GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('4_4_4_4', modelComputer.find(model => model.name === "HP ProDesk 600 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
    ...
    },
    {
        ...
        memoriaRamModules: transformarStringToArray('8_8_16_16', modelComputer.find(model => model.name === "HP EliteDesk 800 G4 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 11 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64-bit']).id,
    ...
    },
    {
        ...
        memoriaRamModules: transformarStringToArray('8_8_8_8', modelComputer.find(model => model.name === "HP ProDesk 600 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
    ...
    },
    {
        ...
        memoriaRamModules: transformarStringToArray('4_4_4', modelComputer.find(model => model.name === "HP ProDesk 600 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Enterprise']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i7-4770 CPU @ 3.40GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('4_8_4', modelComputer.find(model => model.name === "HP ProDesk 600 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-2400 CPU @ 3.10GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('8_8', modelComputer.find(model => model.name === "HP Compaq 6200 Pro SFF PC").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro N']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-4590 CPU @ 3.30GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('8', modelComputer.find(model => model.name === "ThinkCentre M83").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 7 Professional']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['32 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-4590 CPU @ 3.30GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('4_4_4_4', modelComputer.find(model => model.name === "ThinkCentre M83").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 7 Professional']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['32 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-4590 CPU @ 3.30GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 16,
        memoriaRamModules: transformarStringToArray('8_8', modelComputer.find(model => model.name === "ThinkCentre M83").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 7 Professional']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['32 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-8500T CPU @ 2.10GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('8', modelComputer.find(model => model.name === "HP ProDesk 600 G4 DM (TAA)").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['250']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['SDDM2']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 11 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-4570 CPU @ 3.20GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('2_2_4', modelComputer.find(model => model.name === "HP ProDesk 600 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-4570 CPU @ 3.20GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('2_2_2_2', modelComputer.find(model => model.name === "HP ProDesk 600 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-4570 CPU @ 3.20GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 12,
        memoriaRamModules: transformarStringToArray('4_8', modelComputer.find(model => model.name === "HP ProDesk 600 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Pentium(R) CPU G640 @ 2.80GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 4,
        memoriaRamModules: transformarStringToArray('4', modelComputer.find(model => model.name === "HP Compaq Pro 4300 SFF PC").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 7 Professional']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-4590 CPU @ 3.30GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 8,
        memoriaRamModules: transformarStringToArray('4_4', modelComputer.find(model => model.name === "HP ProDesk 400 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['SDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 10 Pro']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM) i5-4590 CPU @ 3.30GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 6,
        memoriaRamModules: transformarStringToArray('4_2', modelComputer.find(model => model.name === "HP ProDesk 400 G1 SFF").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['1000']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 7 Professional']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['64 bits']).id,
