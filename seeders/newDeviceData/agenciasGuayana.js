...
const agenciaGuayana = [
    ...
    },
    {
        ...
        memoryRamCapacity: 3,
        memoriaRamModules: transformarStringToArray('0.5_1_0.5_1', modelComputer.find(model => model.name === "HP Compaq dc5700 Small Form Factor").slots),
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM)2 Duo CPU     E4600  @ 2.40GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 3,
        memoriaRamModules: transformarStringToArray('1_0.25_1_0.25', modelComputer.find(model => model.name === "HP Compaq dc5800 Small Form Factor").slots),
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Celeron(R) CPU          420  @ 1.60GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 2,
    ...
    },
    {
        ...
        processorId: processors.find(process => 'Intel(R) Core(TM)2 Duo CPU     E4600  @ 2.40GHz'.includes(process.number_model)).id,
        memoryRamCapacity: 2,
        memoriaRamModules: transformarStringToArray('1_0.5_0.25_0.5', modelComputer.find(model => model.name === "HP Compaq dc5800 Small Form Factor").slots),
        hardDriveCapacityId: hddCapacities.find(hdd => hdd.name === hddCapacitiesName['500']).id,
        hardDriveTypeId: hddTypes.find(hdd => hdd.name === hddTypeName['HDD']).id,
        operatingSystemId: operatingSystem.find(os => os.name === osName['Microsoft Windows 7 Professional ']).id,
        operatingSystemArqId: operatingSystemArq.find(os => os.name === osArqName['32 bits']).id,
