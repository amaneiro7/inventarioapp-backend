...
const array = [
	...
	{
		id: 'e859b5da-ab94-49fa-953a-7f9d4341935d',
		serial: 'MJ00XUD2',
		serialMatch: 'MJ00XUD2',
		memory_ram: [4, 4],
		memory_ram_capacity: 8
	},
	{
		id: '1d0f80e2-1f4e-42c2-9149-6e3a5853dc6a',
		serial: 'MJ00XUBQ',
		serialMatch: 'MJ00XUBQ',
		memory_ram: [4, 4],
		memory_ram_capacity: 8
	},
	{
		id: '41d3ffd5-1359-4851-b79d-f534c5ada974',
		serial: 'MJ00XUAA',
		serialMatch: 'MJ00XUAA',
		memory_ram: [4, 4],
		memory_ram_capacity: 8
	},
	{
		id: '0bb0c682-8f54-4450-b9eb-87d67a918789',
		serial: 'MJ00XUD8',
		serialMatch: 'MJ00XUD8',
		memory_ram: [4, 4],
		memory_ram_capacity: 8
	},
	{
	...
	{
		id: '184555b2-b533-45a2-a81c-a55601ab4212',
		serial: 'LRGL100',
		serialMatch: 'LRGL100',
		memory_ram: [2, 1],
	...
	{
		id: '976a1f9e-4bcd-4bb4-a754-6ece662b450d',
		serial: 'PF26GM8G',
		serialMatch: 'PF26GM8G',
		memory_ram: [8, 8],
		memory_ram_capacity: 16
	},
	{
...
module.exports = {
	async up(queryInterface, Sequelize) {
		await Promise.all(
			array.map(async ({ id, memory_ram, memory_ram_capacity }) => {
