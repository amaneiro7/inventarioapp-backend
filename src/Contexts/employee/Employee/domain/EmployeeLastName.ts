...
export class EmployeeLastName extends StringValueObject {
  ...
  private ensureIsValidName(value: string): void {
    ...
    if (!this.Regex.test(value)) {
      errors.push(`La primera letra debe ser en mayúsculas, el resto en minúsculas, y no puede tener espacios al final al menos que sea un apellido compuesto`)
    }
  ...
  static async updateNameField({ name, entity }: { name?: Primitives<EmployeeLastName>, entity: RegularEmployee }): Promise<void> {
