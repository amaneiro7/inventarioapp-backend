...
export class RegularEmployee extends Employee {
	constructor(
		...
		directivaId: DepartmentId,
		vicepresidenciaEjecutivaId: DepartmentId | null,
		vicepresidenciaId: DepartmentId | null,
		departamentoId: DepartmentId | null,
		cargoId: CargoId,
		extension: Extension[],
		phone: PhoneNumber[]
	) {
