...
import { IDepartment, type DepartmentPrimitives } from "../../IDepartment/IDeparment"
...
export class VicepresidenciaEjecutiva extends IDepartment {
    ...
    static create(params: Omit<VicepresidenciaEjecutivaPrimitives, 'id'>): VicepresidenciaEjecutiva {
