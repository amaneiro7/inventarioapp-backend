...
import { VicepresidenciaEjecutiva, VicepresidenciaEjecutivaPrimitives } from "../domain/VicepresidenciaEjecutiva"
...
export class VicepresidenciaEjecutivaCreator {
  ...
  constructor(
    ...
    this.createVicepresidenciaEjecutivaUseCase = new CreateVicepresidenciaEjecutivaUseCase(this.vicepresidenciaEjecutivaRepository, this.directivaRepository)
  }

  async run({ name, directivaId }: Omit<VicepresidenciaEjecutivaPrimitives, 'id'>): Promise<void> {

    await this.createVicepresidenciaEjecutivaUseCase.execute({ name, directivaId })

    const vicepresidenciaEjecutiva = VicepresidenciaEjecutiva.create({ name, directivaId })
