...
export class SequelizeVicepresidenciaEjecutivaRepository implements DepartmentRepository<VicepresidenciaEjecutivaPrimitives> {
    ...
    async searchById(id: Primitives<DepartmentId>): Promise<Nullable<VicepresidenciaEjecutivaPrimitives>> {
        return await VicepresidenciaEjecutivaModel.findByPk(id) ?? null
    }

    async searchByName(name: Primitives<DepartmentName>): Promise<Nullable<VicepresidenciaEjecutivaPrimitives>> {
        return await VicepresidenciaEjecutivaModel.findOne({ where: { name } }) ?? null
    }
