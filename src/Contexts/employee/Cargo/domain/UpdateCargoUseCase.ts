...
export class UpdateCargoUseCase {
    ...
    public async execute({ params: { name, departamentos }, entity }: { entity: Cargo, params: Partial<Omit<CargoPrimitives, 'id'>> }): Promise<void> {
    ...
    private async ensureDepartamentosExists({ entity, departamentos }: { departamentos?: Primitives<DepartmentId>[], entity: Cargo }): Promise<void> {
