...
export class CentroTrabajoModel extends Model<CentroTrabajoPrimitives> implements CentroTrabajoPrimitives {
  ...
  static async associate(models: Sequelize['models']): Promise<void> {
    this.belongsTo(models.CentroCosto, { as: 'centroCosto', foreignKey: 'centroCostoId' }) // Un CentroTrabajo pertenece a un CentroCosto
    this.hasMany(models.Employee, { as: 'employee', foreignKey: 'centroTrabajoId' })
  }
