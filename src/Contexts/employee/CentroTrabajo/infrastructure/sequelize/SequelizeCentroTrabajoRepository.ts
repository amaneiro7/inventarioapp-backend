...
export class SequelizeCentroTrabajoRepository implements CentroTrabajoRepository {
  ...
  async searchByName(name: Primitives<CentroTrabajoName>): Promise<Nullable<CentroTrabajoPrimitives>> {
