...
import { type ModelSeriesParams, type ModelSeriesPrimitives } from '../../../ModelSeries/domain/dto/ModelSeries.dto'
import { type CartridgeModel } from '../valueObject/CartridgeModel'
...
export type PrinteModelsField = keyof Omit<PrinteModelsPrimitives, 'id'>
/**
