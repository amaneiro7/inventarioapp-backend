...
import { type OperatingSystemArqDto } from '../entity/OperatingSystemArq.dto'
...
export abstract class OperatingSystemArqRepository {
	...
	abstract findByIds: (ids: Array<Primitives<OperatingSystemArqId>>) => Promise<OperatingSystemArqDto[]>
}
