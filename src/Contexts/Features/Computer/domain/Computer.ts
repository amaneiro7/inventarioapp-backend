...
export class DeviceComputer extends Device {
	constructor(
		...
		if (
			!DeviceComputer.isComputerCategory({ categoryId: categoryId.value })
		) {
	...
	static create(params: DeviceComputerParams): DeviceComputer {
		...
		return new DeviceComputer(
			...
			new ComputerMemoryRamCapacity(
				ComputerMemoryRam.totalAmount(params.memoryRam),
				params.statusId
			),
			new ComputerHardDriveCapacity(
				params.hardDriveCapacityId,
				params.statusId
			),
			new ComputerHardDriveType(
			...
			new ComputerOperatingSystemArq(
	...
	static fromPrimitives(
		primitives: DeviceComputerPrimitives
	): DeviceComputer {
		return new DeviceComputer(
	...
	updateComputerName(
		newComputerName: Primitives<ComputerName>,
	...
	updateMemoryRamCapacity(
		...
		this.memoryRamCapacity = new ComputerMemoryRamCapacity(
			newMemoryRamCapacity,
			status
		)
	}
	...
	updateOperatingSystem(
		...
		this.operatingSystemId = new ComputerOperatingSystem(
			newOperatingSystem,
			hardDriveCapacity,
			status
		)
	...
	updateOperatingSystemArq(
		...
		this.operatingSystemArqId = new ComputerOperatingSystemArq(
			newOperatingSystemArq,
			opertaingSystem
		)
	}
	...
	updateHardDriveCapacity(
		...
		this.hardDriveCapacityId = new ComputerHardDriveCapacity(
			newHDDCapacity,
			status
		)
	}
	...
	updateHardDriveType(
		...
		this.hardDriveTypeId = new ComputerHardDriveType(
			newHDDType,
			hardDriveCapacity
		)
	}
	...
	updateIPAddress(
		newIPAddress: Primitives<IPAddress>,
		status: Primitives<DeviceStatus>
	): void {
