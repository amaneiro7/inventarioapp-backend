...
const newDeviceToAdd = [
	{
		...
		employeeId: 'jsalguedo'.trim().toLowerCase(),
	...
	},
	{
		...
		employeeId: 'lugonzalez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jnoguera'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'hespinoza'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'ioliveira'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'OBELTECH-20\Obeltech'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'jquintal'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'ricgonzalez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'svidal'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'yescobar'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'ydavila'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'hrico'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'OBELTECH\Enrique'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'soropeza'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'mquintero'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'almartinez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'negonzalez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'smorin'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'cfernandez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'obeltech20\Obeltech'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP EliteDesk 800 G4 DM 35W (TAA)')?.id,
		employeeId: 'ggarcia'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'arrosales'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'cmaza'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jgomes'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP EliteDesk 800 G4 DM 35W (TAA)')?.id,
		employeeId: 'liromero'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'mcarrasco'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jperez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'omota'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'mramos'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['BOLEITA'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP EliteDesk 800 G4 DM 35W (TAA)')?.id,
		employeeId: 'jalarcon'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP EliteDesk 800 G4 DM 65W (TAA)')?.id,
		employeeId: 'yogonzalez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'rasandoval'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'ocolina'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP EliteDesk 800 G4 DM 35W (TAA)')?.id,
		employeeId: 'emarquez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'jemarin'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'jealdana'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'lpulido'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'hcalatayud'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'jgarrido'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'dcardenas'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'dasulbaran'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'fagustin'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 400 G1 SFF')?.id,
		employeeId: 'josbhernandez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'mcaprasio'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'yabriceno'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'rvivenes'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'bncmcafee'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'vvarani'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'nyepez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'vijimenez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'mcarrillo'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'sfernandez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP EliteDesk 800 G4 DM 35W (TAA)')?.id,
		employeeId: 'vsuarez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'cmilano'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G4 DM (TAA)')?.id,
		employeeId: 'mamorales'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M73z')?.id,
		employeeId: 'lpalazzi'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'dbasanta'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'apaolini'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Elite 8300 SFF')?.id,
		employeeId: 'jpepper'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'druiz'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'mapino'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'orgonzalez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'afagundez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'cvelandia'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'gcolmenares'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jbrowh'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'jsouquett'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 400 G1 SFF')?.id,
		employeeId: 'darcia'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'pmolina'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'edcaraballo'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M83')?.id,
		employeeId: 'lchang'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'cpena'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP EliteDesk 800 G4 DM 35W (TAA)')?.id,
		employeeId: 'rigutierrez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'johrodriguez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'nbrito'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'sroque'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'ymorales'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'anarodriguez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jnieto'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'bsanchez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'fdoveri'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'tgonzalez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'aperez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'bbolivar'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'naaponte'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'cazambrano'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'yavelasquez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jmarquina'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'pbovy'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'marpalacios'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'jferrer'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'marperez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'dcorona'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'nbetancourt'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'bcanelon'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'nfinol'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jesulopez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'romarquez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'aavendano'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'irestrepo'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'vlopez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M73z')?.id,
		employeeId: 'amtorres'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'lvalor'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'llovera'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'jepina'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'ydaza'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'prodriguez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'mfigueroa'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'ycastillo'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'josmlopez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'anaortiz'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'yuvarela'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'oleon'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'dmanrrique'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'lsobrado'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'mareyes'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'cbarrios'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'gamarquez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'aabreu'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'aprado'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 400 G1 SFF')?.id,
		employeeId: 'egcontreras'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'iflores'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jcordero'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'lalarcon'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'kguillen'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'landrade'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'yuzcategui'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'jobriceno'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'lramos'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'daraque'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'Ialbarracin'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'epineda'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'erserrano'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'vcastro'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jhsanchez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'gfernandez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'mespinoza'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'klozada'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'faleal'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jmoncada'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'agarcia'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jalinares'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'gcontreras'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jgandica'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jegraterol'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'lejimenez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'lbermudez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'drondon'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'abaptista'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'yalvarez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'kotamendis'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'lrojas'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'lameza'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'bdeandrade'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'jopacheco'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'eagreda'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'anagonzalez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'lsantiago'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'daugello'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'mguilarte'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'ctovar'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'eguerrero'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'garteaga'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'eserpa'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'mvalladares'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'saure'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'lmoreno'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'jcardenas'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'dnavarro'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'vchitgian'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'yecastro'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'kdiaz'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'rpuentes'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'gdugarte'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'flacruz'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'mfernandez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'aspalacios'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'gabgonzalez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'raleman'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'cprieto'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'snacad'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Pro Mini 400 G9 Desktop PC')?.id,
		employeeId: 'anmarin'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['ROSAL'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'respanol'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'borellana'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'tmarquez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'mebastidas'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'jocarmona'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'iblanco'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'AGUTIERREZ'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(014)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'adgraterol'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(014)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'naular'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'pgonzalez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(029)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'jeaponte'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'darias'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'kgonzalez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq dc5800 Small Form Factor')?.id,
		employeeId: 'krgonzalez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'lurojas'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'girangel'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'angutierrez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'jaserrano'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(063)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'vlaguna'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'llanda'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'andromero'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(071)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'npena'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'suherrera'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'yostos'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'fasuaje'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(088)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'gsanchez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'cguevara'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'magomez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'josalvarez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'cvarela'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'mfrontado'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(109)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'drico'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'ydelpino'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(110)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'baraque'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 8000 Elite SFF PC')?.id,
		employeeId: 'rvera'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'ancolmenarez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'glugo'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(144)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'earay'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'abeltran'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'sgonzalez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'bflores'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'jmerchan'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'mrivas'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 400 G1 SFF')?.id,
		employeeId: 'lumorales'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'wbarrera'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(209)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'ovaquero'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(209)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 8000 Elite SFF PC')?.id,
		employeeId: 'djimenez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'davila'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 400 G1 SFF')?.id,
		employeeId: 'mmonterrey'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'earcia'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M83')?.id,
		employeeId: 'ecaldera'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq dc5800 Small Form Factor')?.id,
		employeeId: 'didelgado'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'gorta'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(129)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'ccalanche'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'kasalazar'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'ycazano'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 8000 Elite SFF PC')?.id,
		employeeId: 'ysuescuns'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'nocastillo'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'jortega'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'maular'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'dalvarez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'yugarcia'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(254)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'fabriceno'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(254)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'jpoleo'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(255)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'cgallardo'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'glhernandez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 8000 Elite SFF PC')?.id,
		employeeId: 'fleal'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(265)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'bmendoza'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'tgomez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'mariagonzalez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'aavilan'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(272)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'yguanda'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'lmendoza'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(257)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'dparica'.trim().toLowerCase(),
	...
	},
	{
		...
		employeeId: 'leperez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'raranguren'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'smartinez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'mmalave'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M72e')?.id,
		employeeId: 'marrodriguez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'micontreras'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(098)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'bmendez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(098)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'midiaz'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'yrodriguez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(098)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'dsequera'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(098)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'aalfonzo'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6200 Pro SFF PC')?.id,
		employeeId: 'evelasquez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'dcova'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'hepereira'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'ccarrasquel'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(098)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'saguilarte'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(098)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'jnocente'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(088)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		employeeId: 'diruiz'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'dgarcia'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(012)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'yosuarez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(052)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'josearodriguez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(110)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'jjari'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(151)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'diugonzalez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(282)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'gcardenas'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(035)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'anmoya'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(001)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'tcedeno'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(011)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'ealbornoz'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(013)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'jananguren'.trim().toLowerCase(),
	...
	},
	{
		...
		employeeId: 'laranguren'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'vgraterol'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(021)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'rorozco'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M72e')?.id,
		employeeId: 'dgalindez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(043)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'ymendez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(165)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'yumartinez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'OVALDERREY'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'clacruz'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M83')?.id,
		employeeId: 'dparedes'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(052)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'ezarate'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(052)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'mpupo'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'angimartinez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(055)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6200 Pro SFF PC')?.id,
		employeeId: 'damendoza'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(059)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M72e')?.id,
		employeeId: 'fortega'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(059)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M72e')?.id,
		employeeId: 'fpoleo'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(153)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'gcumare'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(071)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'mavelasquez'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'sdurand'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'iespinoza'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'ejimenez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'ylabrador'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6200 Pro SFF PC')?.id,
		employeeId: 'rrojas'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M83')?.id,
		employeeId: 'lramirez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq dc5800 Small Form Factor')?.id,
		employeeId: 'zliscano'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M83')?.id,
		employeeId: 'lcastro'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(013)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'joespinoza'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(146)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'lesuarez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(153)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M83')?.id,
		employeeId: 'ggudino'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'acroce'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(171)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'lmattey'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP ProDesk 600 G1 SFF')?.id,
		employeeId: 'rvargas'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(176)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'acanache'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(176)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M72e')?.id,
		employeeId: 'kigutierrez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(181)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 8000 Elite SFF PC')?.id,
		employeeId: 'jmillan'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(214)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'yabreu'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'tsoto'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'jgelves'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'rurodriguez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(257)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'efgarcia'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'argodoy'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(261)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'cbracamonte'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(272)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'carmartinez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(273)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'cfarache'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'ecotogno'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'adviazzo'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(285)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'ezrivas'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(285)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'anramos'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'mcivira'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(011)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'jzamor'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(043)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq Pro 6300 SFF')?.id,
		employeeId: 'adegarcia'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(257)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 6000 Pro SFF PC')?.id,
		employeeId: 'gquintana'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq dc5800 Small Form Factor')?.id,
		employeeId: 'hrosales'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M83')?.id,
		employeeId: 'domendez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M700')?.id,
		employeeId: 'ycastro'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(127)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'jmaturel'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'ecalderin'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(098)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'ydguzman'.trim().toLowerCase(),
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['Hewlett-Packard'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Compaq 8000 Elite SFF PC')?.id,
		employeeId: 'legonzalez'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(213)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'acabello'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(098)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'yrivero'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(098)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M71e')?.id,
		employeeId: 'npinero'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(013)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['HP'])?.id,
		modelId: modelComputer.find(model => model.name === 'HP Elite Mini 800 G9 Desktop PC')?.id,
		employeeId: 'alupi'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(098)'])[0]?.id,
		observation: '',
	...
	},
	{
		...
		brandId: brandsData.find(brand => brand.name === brandOnlyName['LENOVO'])?.id,
		modelId: modelComputer.find(model => model.name === 'ThinkCentre M720q')?.id,
		employeeId: 'yuguzman'.trim().toLowerCase(),
		locationId: agenciasSite.filter(location => location.name === agenciaName['AGENCIA(235)'])[0]?.id,
		observation: '',
