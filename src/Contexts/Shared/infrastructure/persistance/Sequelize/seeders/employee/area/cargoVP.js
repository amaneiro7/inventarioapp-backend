...
const cargoVPData = [
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['GERENCIA DE AREA DE AUDITORIA DE AGENCIAS']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE AREA'])[0].id
	},
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['GERENCIA DE AREA ASUNTOS REGULATORIOS'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['AUDITOR JUNIOR'])[0].id
	},
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['GERENCIA DE ÁREA CTRL Y SEGUIMIENTO DE AUDITORÍA']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE AREA'])[0].id
	},
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['GERENCIA DE AREA AUDITORIA FINANCIERA'])[0]
			.id,
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['GERENCIA DE AREA AUDITORIA DE SISTEMAS'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE AREA'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['GERENCIA APOYO A PRESIDENCIA EJECUTIVA'])[0]
			.id,
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['GERENCIA DE AREA VALORES Y ACCIONISTAS'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE AREA DE NEGOCIOS'])[0].id
	},
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['GERENCIA DE ÁREA PROYECTOS DE DESARROLLO SOSTENIBLE']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE AREA'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['GERENCIA DE RIESGO OPERACIONAL MID Y BACK OFFICE']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE DEPARTAMENTO'])[0].id
	},
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['GERENCIA DE MONITOREO Y SEG. SOBRE CONT. DE NEG']
		)[0].id,
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['GERENCIA DE RIESGO DE MERCADO Y LIQUIDEZ'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE DEPARTAMENTO'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['GERENCIA ESTADÍSTICA SOBRE METODOLOGÍA DE RIESGO']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE DEPARTAMENTO'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['GERENCIA RIESGO OPERACIONAL FRONT OFFICE'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE DEPARTAMENTO'])[0].id
	},
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['GERENCIA DE METODOLOGÍA DE RIESGO FINANCIERO']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE DEPARTAMENTO'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['GERENCIA DE AREA SEGURIDAD INFORMATICA'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE AREA'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['V.P. GESTION DE CONTABILIDAD PAGOS Y TRIBUTOS']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['V.P. INFRAESTRUCTURA Y MANTENIMIENTO FISICO']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['V.P. PLANIFICACIÓN FINANCIERA Y PRESUPUESTO']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['V.P. CORPORATIVA BEI SECTOR FINANCIERO'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE DE NEGOCIOS'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['V.P. CORPORATIVA BEI SECTOR AGROPECUARIO'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE DE NEGOCIOS'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['V.P. CUMPLIMIENTO Y CONTROL DE GESTIÓN'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['V.P. REGIONAL ADMINISTRACIÓN DE AGENCIAS'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE REGIONAL'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['V.P. GESTIÓN ORGANIZACIONAL Y PROCESOS'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['V.P. DE RECURSOS HUMANOS Y CULTURA ORGANIZACIONAL']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['V.P. SEGURIDAD PREVENTIVA Y PROTECCIÓN FÍSICA']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['V.P. SEGUIMIENTO Y CONTROL DE CREDITO'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['GERENCIA DE ÁREA DE COBRANZA Y RECUPERACIONES']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE AREA'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['GERENCIA DE AREA PROYECTOS ESPECIALES'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE AREA'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['V.P. DE MERCADEO Y COMUNICACIONES CORPORATIVAS']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['V.P. INTELIGENCIA DE NEGOCIOS Y ANALÍTICA DIGITAL']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
		vicepresidenciaId: VPData.filter(
			dep => dep.name === VPOnlyNames['V.P. DE PRODUCTOS Y SERVICIOS DE TARJETAS']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
	...
	{
		vicepresidenciaId: VPData.filter(dep => dep.name === VPOnlyNames['V.P. DESAROLLO DE NEGOCIOS E INNOVACIÓN'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	}
]
