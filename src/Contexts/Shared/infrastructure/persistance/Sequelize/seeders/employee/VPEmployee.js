...
const VPEmployee = [
	{
		...
		vicepresidenciaId: VPData.filter(vp => vp.name === VPOnlyNames['GERENCIA DE AREA DE AUDITORIA DE AGENCIAS'])[0]
			.id,
		departamentoId: null,
	...
	},
	{
		...
		vicepresidenciaId: VPData.filter(
			vp => vp.name === VPOnlyNames['GERENCIA DE ÁREA CTRL Y SEGUIMIENTO DE AUDITORÍA']
		)[0].id,
		departamentoId: null,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE AREA'])[0].id,
		extension: [],
	...
	},
	{
		...
		vicepresidenciaId: VPData.filter(
			vp => vp.name === VPOnlyNames['GERENCIA DE ÁREA PROYECTOS DE DESARROLLO SOSTENIBLE']
		)[0].id,
		departamentoId: null,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE AREA'])[0].id,
		extension: [],
	...
	},
	{
		...
		cedula: 10995485,
		locationId: null,
		directivaId: VPEData.filter(vpe => vpe.name === VPEOnlyNames['UNIDAD ADMON INTEGRAL DE RIESGOS'])[0]
			.directivaId,
		vicepresidenciaEjecutivaId: VPEData.filter(
			vpe => vpe.name === VPEOnlyNames['UNIDAD ADMON INTEGRAL DE RIESGOS']
		)[0].id,
		vicepresidenciaId: VPData.filter(
			vp => vp.name === VPOnlyNames['GERENCIA DE RIESGO OPERACIONAL MID Y BACK OFFICE']
		)[0].id,
		departamentoId: null,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE DEPARTAMENTO'])[0].id,
		extension: [],
	...
	},
	{
		...
		vicepresidenciaId: VPData.filter(
			vp => vp.name === VPOnlyNames['GERENCIA DE MONITOREO Y SEG. SOBRE CONT. DE NEG']
		)[0].id,
		departamentoId: null,
	...
	},
	{
		...
		vicepresidenciaId: VPData.filter(vp => vp.name === VPOnlyNames['GERENCIA DE RIESGO DE MERCADO Y LIQUIDEZ'])[0]
			.id,
		departamentoId: null,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE DEPARTAMENTO'])[0].id,
		extension: [],
	...
	},
	{
		...
		vicepresidenciaId: VPData.filter(
			vp => vp.name === VPOnlyNames['GERENCIA ESTADÍSTICA SOBRE METODOLOGÍA DE RIESGO']
		)[0].id,
		departamentoId: null,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE DEPARTAMENTO'])[0].id,
		extension: [],
	...
	},
	{
		...
		vicepresidenciaId: VPData.filter(vp => vp.name === VPOnlyNames['GERENCIA RIESGO OPERACIONAL FRONT OFFICE'])[0]
			.id,
		departamentoId: null,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE DEPARTAMENTO'])[0].id,
		extension: [],
	...
	},
	{
		...
		vicepresidenciaId: VPData.filter(
			vp => vp.name === VPOnlyNames['GERENCIA DE METODOLOGÍA DE RIESGO FINANCIERO']
		)[0].id,
		departamentoId: null,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['GERENTE DE DEPARTAMENTO'])[0].id,
		extension: [],
