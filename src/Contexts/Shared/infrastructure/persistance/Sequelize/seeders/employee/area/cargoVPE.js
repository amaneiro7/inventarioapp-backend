...
const cargoVPEData = [
	...
	},
	{
		vicepresidenciaEjecutivaId: VPEData.filter(
			dep => dep.name === VPEOnlyNames['SECRETARIA DE LA JUNTA DIRECTIVA']
		)[0].id,
	...
	{
		vicepresidenciaEjecutivaId: VPEData.filter(
			dep => dep.name === VPEOnlyNames['UNIDAD ADMON INTEGRAL DE RIESGOS']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
		vicepresidenciaEjecutivaId: VPEData.filter(
			dep => dep.name === VPEOnlyNames['V.P. SEGURIDAD DE LA INFORMACION']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE'])[0].id
	},
	{
	...
	{
		vicepresidenciaEjecutivaId: VPEData.filter(
			dep => dep.name === VPEOnlyNames['V.P.E. BANCA CORPORATIVA EMPRESAS E INSTITUCIONES']
		)[0].id,
	...
	{
		vicepresidenciaEjecutivaId: VPEData.filter(
			dep => dep.name === VPEOnlyNames['V.P.E. DESARROLLO ORGANIZACIONAL Y TRANSFORMACIÓN']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['ASISTENTE EJECUTIVA'])[0].id
	},
	{
	...
	{
		vicepresidenciaEjecutivaId: VPEData.filter(
			dep => dep.name === VPEOnlyNames['V.P.E. GESTIÓN DE LA SEGURIDAD Y PREVENCIÓN']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE EJECUTIVO'])[0].id
	},
	{
	...
	{
		vicepresidenciaEjecutivaId: VPEData.filter(dep => dep.name === VPEOnlyNames['V.P.E. INGENIERIA TECNOLÓGICA'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['ESPECIALISTA JUNIOR'])[0].id
	},
	{
	...
	{
		vicepresidenciaEjecutivaId: VPEData.filter(
			dep => dep.name === VPEOnlyNames['V.P.E. OPERACIONES CENTRALIZADAS']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['VICEPRESIDENTE EJECUTIVO'])[0].id
	},
	{
	...
	{
		vicepresidenciaEjecutivaId: VPEData.filter(dep => dep.name === VPEOnlyNames['V.P.E. SERVICIOS JURÍDICOS'])[0]
			.id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['MENSAJERO EXTERNO'])[0].id
	},
	{
		vicepresidenciaEjecutivaId: VPEData.filter(
			dep => dep.name === VPEOnlyNames['V.P.E. SOLUCIONES DE CLIENTES Y SERV. DIGITALES']
		)[0].id,
		cargoId: cargosData.filter(cargo => cargo.name === cargoOnlyNames['ASISTENTE EJECUTIVA'])[0].id
	},
	{
