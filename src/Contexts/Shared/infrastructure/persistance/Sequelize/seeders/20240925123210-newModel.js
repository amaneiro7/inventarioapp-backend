...
module.exports = {
	async up(queryInterface, Sequelize) {
		const mouseModel = models.filter(model =>
			categoryData.filter(category => category.name === categoryOnlyNames.MOUSE)[0].id.includes(model.categoryId)
		)
		try {
