...
const torreElRosal = [
	...
	},
	{
		...
		processorId: processors.find(process =>
			'AMD Athlon Silver 3050U with Radeon Graphics'.includes(process.number_model)
		).id,
		memoryRamCapacity: 4,
		memoriaRamModules: [4],
	...
	},
	{
		...
		processorId: processors.find(process => 'AMD Ryzen 3 3250U with Radeon Graphics'.includes(process.number_model))
			.id,
		memoryRamCapacity: 8,
		memoriaRamModules: [8],
		hardDriveCapacityId: hddCapacities.filter(hdd => hdd.name === hddCapacitiesName['250'])[0].id,
	...
	},
	{
		...
		operatingSystemId: operatingSystem.filter(
			os => os.name === osName['Microsoft Windows 10 Pro for Workstations']
		)[0].id,
		operatingSystemArqId: operatingSystemArq.filter(os => os.name === osArqName['64 bits'])[0].id,
		macAddress: null,
	...
	},
	{
		...
		processorId: processors.find(process =>
			'11th Gen Intel(R) Core(TM) i5-1145G7 @ 2.60GHz'.includes(process.number_model)
		).id,
		memoryRamCapacity: 16,
		memoriaRamModules: [8, 8],
		hardDriveCapacityId: hddCapacities.filter(hdd => hdd.name === hddCapacitiesName['500'])[0].id,
	...
	},
	{
		...
		processorId: processors.find(process =>
			'Intel(R) Core(TM) i7-4790 CPU @ 3.60GHz'.includes(process.number_model)
		).id,
		memoryRamCapacity: 8,
		memoriaRamModules: [8, 0, 0, 0],
		hardDriveCapacityId: hddCapacities.filter(hdd => hdd.name === hddCapacitiesName['1000'])[0].id,
	...
	},
	{
		...
		processorId: processors.find(process =>
			'11th Gen Intel(R) Core(TM) i7-1165G7 @ 2.80GHz'.includes(process.number_model)
		).id,
		memoryRamCapacity: 16,
		memoriaRamModules: [8, 8],
		hardDriveCapacityId: hddCapacities.filter(hdd => hdd.name === hddCapacitiesName['1000'])[0].id,
	...
	},
	{
		...
		hardDriveCapacityId: hddCapacities.filter(hdd => hdd.name === hddCapacitiesName['500'])[0].id,
		hardDriveTypeId: hddTypes.filter(hdd => hdd.name === hddTypeName['SDD'])[0].id,
		operatingSystemId: operatingSystem.filter(os => os.name === osName['Microsoft Windows 10 Enterprise LTSC'])[0]
			.id,
		operatingSystemArqId: operatingSystemArq.filter(os => os.name === osArqName['64 bits'])[0].id,
		macAddress: null,
	...
	},
	{
		...
		processorId: processors.find(process => 'Intel(R) Xeon(R) W-2133 CPU @ 3.60GHz'.includes(process.number_model))
			.id,
	...
	},
	{
		...
		processorId: processors.find(process =>
			'Intel(R) Core(TM) i7-6820HQ CPU @ 2.70GHz'.includes(process.number_model)
		).id,
		memoryRamCapacity: 16,
		memoriaRamModules: [8, 8, 0, 0],
		hardDriveCapacityId: hddCapacities.filter(hdd => hdd.name === hddCapacitiesName['500'])[0].id,
	...
	},
	{
		...
		processorId: processors.find(process =>
			'Intel(R) Core(TM) i7-2600 CPU @ 3.40GHz'.includes(process.number_model)
		).id,
		memoryRamCapacity: 6,
		memoriaRamModules: [4, 2, 0, 0],
		hardDriveCapacityId: hddCapacities.filter(hdd => hdd.name === hddCapacitiesName['500'])[0].id,
