 ...
 */
export class PermissionGroupPostController implements Controller {
	/**
	...
	async run(req: Request, res: Response, next: NextFunction): Promise<void> {
		try {
			...
			const create: PermissionGroupCreator = container.resolve(PermissionGroupDependencies.Creator)
